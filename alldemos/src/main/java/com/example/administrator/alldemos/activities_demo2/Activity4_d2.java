 ...
 * ---------------------------------------------------
 */
public class Activity4_d2 extends AppCompatActivity{
    @Bind(R.id.bmapView)
    MapView bmapView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.d2_activity4_layout);
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            MyLocationConfiguration config = new MyLocationConfiguration(MyLocationConfiguration.LocationMode.FOLLOWING, true, BitmapDescriptorFactory.fromResource(R.drawable.dark_dot));
